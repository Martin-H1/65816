; -----------------------------------------------------------------------------
; Thirty Two bit math routines for operations using a Forth like data stack.
; These were borrowed from the of816 project, but that author doesn't claim
; they were an original work.
...
; ( d1 n1 -- n2 n3 )
; Divide dividend d1 by divisor n1, giving the floored quotient n3 and the
