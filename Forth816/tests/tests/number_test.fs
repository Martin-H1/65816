...
T{ S" 1234."    NUMTEST-STR NUMBER? -> 1234 0 2 }T
T{ S" 0."       NUMTEST-STR NUMBER? -> 0 0 2 }T
T{ S" 100000."  NUMTEST-STR NUMBER? -> $86A0 1 2 }T
T{ S" -1."      NUMTEST-STR NUMBER? -> -1 -1 2 }T
T{ S" -100000." NUMTEST-STR NUMBER? -> $7960 -2 2 }T
T{ S" 65536."   NUMTEST-STR NUMBER? -> 0 1 2 }T
T{ S" $10000."  NUMTEST-STR NUMBER? -> 0 1 2 }T
